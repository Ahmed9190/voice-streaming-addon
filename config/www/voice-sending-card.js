import{i as t,_ as e,n as i,r as s,a,b as n,t as o,e as c,s as r,W as l}from"./styles-YY3p615I.js";let h=class extends a{setConfig(t){this._config=t}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target;if(this[`_${e.configValue}`]!==e.value){if(e.configValue)if(""===e.value){const t={...this._config};delete t[e.configValue],this._config=t}else this._config={...this._config,[e.configValue]:void 0!==e.checked?e.checked:e.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}}render(){return this.hass&&this._config?n`
  ...
  `,e([i({attribute:!1})],h.prototype,"hass",void 0),e([s()],h.prototype,"_config",void 0),h=e([o("voice-sending-card-editor")],h);let d=class extends a{constructor(){super(...arguments),this.status="disconnected",this.errorMessage="",this.latency=0,this.webrtc=null,this.animationFrame=null}static get styles(){return[r,t`
